...
const DeleteProductPage = () => {
    ...
    const deleteEvent = async () => {
      await axios.delete(`/api/travelsdata?id=${id}`);
        goBack();
    }
    ...
    <AdminLayout>
        <div className='mb-[8%] mt-[8%]'>
            <h1 className='text-center text-2xl text-yellow-950 font-semibold mb-8'>
                Ви точно бажаєте видалити подорож &nbsp;&quot;{travelInfo?.title}&quot;?
            </h1>
            <div className='flex gap-1 justify-center'>
                ...
                <button 
                    className='bg-gray-600 text-white p-1 px-4 text-base font-semibold
